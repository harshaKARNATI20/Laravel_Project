...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <form action="{{ route('tickets.update', $ticket->id) }}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" id="ticket_limit" name="ticket_limit" value="{{ old('ticket_limit', $ticket->ticket_limit) }}" class="form-control @error('ticket_limit') is-invalid @enderror" min="0">
            @error('ticket_limit')
            <span class="help-block">
                <strong>{{ $message }}</strong>
            </span>
